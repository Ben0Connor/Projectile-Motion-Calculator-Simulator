...
class GUI:
    def __init__(self, window):
        ...
        # Register validation command for numeric input
        ...
        self.entry_velocity = tk.Entry(self.main_frame, width=10, validate="key", validatecommand=vcmd)
        ...
        self.entry_angle = tk.Entry(self.main_frame, width=10, validate="key", validatecommand=vcmd)
        ...
        self.entry_gravity = tk.Entry(self.main_frame, width=10, validate="key", validatecommand=vcmd)
